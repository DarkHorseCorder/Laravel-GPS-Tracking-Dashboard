    ...
    <aside
        ...
        <div class="collapse navbar-collapse px-0 w-auto " id="sidenav-collapse-main">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link " href="<?php echo e(route('page', ['page' => 'tables'])); ?>">
                        <div
                            class="icon icon-shape icon-sm border-radius-md text-center ms-2 d-flex align-items-center justify-content-center">
                ...
                <li class="nav-item">
                    <a class="nav-link " href="<?php echo e(route('page', ['page' => 'virtual-reality'])); ?>">
                        <div
                            class="icon icon-shape icon-sm border-radius-md text-center ms-2 d-flex align-items-center justify-content-center">
                ...
                <li class="nav-item">
                    <a class="nav-link active" href="<?php echo e(route('page', ['page' => 'rtl'])); ?>">
                        <div
                            class="icon icon-shape icon-sm border-radius-md text-center ms-2 d-flex align-items-center justify-content-center">
                ...
                <li class="nav-item">
                    <a class="nav-link " href="<?php echo e(route('page', ['page' => 'profile-static'])); ?>">
                        <div
                            class="icon icon-shape icon-sm border-radius-md text-center ms-2 d-flex align-items-center justify-content-center">
...
<?php echo $__env->make('layouts.app', ['class' => 'g-sidenav-show bg-gray-100 rtl'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\Laravel\argon-dashboard-laravel\resources\views/pages/rtl.blade.php ENDPATH**/ ?>
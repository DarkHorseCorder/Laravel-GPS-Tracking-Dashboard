...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div
                            ...
                            <div class="position-relative h-100 m-3 px-7 border-radius-lg d-flex flex-column justify-content-center overflow-hidden"
                                style="background-image: url('https://track.gohomegps.com/images/background.jpg');
              background-size: cover; background-position : right center; align-items : center">
                                <img src="<?php echo e(asset('img/logos/logo.png')); ?>" style="width : 230px; height : 78px"/>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\Laravel\argon-dashboard-laravel\resources\views/auth/login.blade.php ENDPATH**/ ?>